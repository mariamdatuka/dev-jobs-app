import { Background,Wrapper,Container,SwitchContainer,SwitchInput,SwitchKnob } from './Styles'
...
const Header = () => {
  const {isDark,handleToggle}:Props=useContext(themeContext);
  ...
  return (
    ...
    <Background>
       ...
       <Container> 
        ...
        <SwitchContainer>
          <SwitchInput type="checkbox"  checked={isDark} onChange={handleToggle} />
          <SwitchKnob/>
       </SwitchContainer>
